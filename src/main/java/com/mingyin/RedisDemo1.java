...
//        System.out.println("We posted a new article with id: " + articleId);//发布文章
//

        String articleId = "1";
        articleVote(conn, "other_user", "article:" + articleId);//投票
    ...
    public List<Map<String,String>> getArticles1(Jedis conn, int page) {
        ...
        Set<String> stringSet=conn.zrevrange("votes",start,end);
        List<Map<String,String>> articles = new ArrayList<Map<String,String>>();
